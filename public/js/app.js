...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _domready = __webpack_require__(315);
...
/***/ function(module, exports) {
  ...
  var GoogleAnalyticsClient = function () {
      function GoogleAnalyticsClient() {
          _classCallCheck(this, GoogleAnalyticsClient);
      }

      _createClass(GoogleAnalyticsClient, [{
          key: 'scrolledToStory',
          value: function scrolledToStory() {
              this._send('scroll', 'story', '', { once: true });
          }
      }, {
          key: 'scrolledToBrowse',
          value: function scrolledToBrowse() {
              this._send('scroll', 'browse', '', { once: true });
          }
      }, {
          key: 'scrolledToPurchase',
          value: function scrolledToPurchase() {
              this._send('scroll', 'purchase', '', { once: true });
          }
      }, {
          key: 'openMangaViewer',
          value: function openMangaViewer() {
              this._send('open', 'manga', '', {});
          }
      }, {
          key: 'closeMangaViewer',
          value: function closeMangaViewer(pageNumber) {
              this._send('close', 'manga', pageNumber, {});
          }
      }, {
          key: 'goToWebCatalog',
          value: function goToWebCatalog() {
              this._send('goto', 'catalog', '', {});
          }
      }, {
          key: 'goToPixivSample',
          value: function goToPixivSample(bookName) {
              this._send('goto', 'pixiv', bookName, {});
          }
      }, {
          key: 'goToBooth',
          value: function goToBooth() {
              this._send('goto', 'booth', '', {});
          }
      }, {
          key: '_send',
          value: function _send(category, action, label, _ref) {
              var once = _ref.once;
          ...
          key: '_doNotSendAgain',
          value: function _doNotSendAgain(category, action, label) {
              window.sessionStorage[category + '-' + action + '-' + label] = 1;
          }
      }, {
          key: '_hasSent',
          value: function _hasSent(category, action, label) {
  ...
  exports.default = GoogleAnalyticsClient;
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _keyMirror = __webpack_require__(323);
  ...
  var SCROLL_ACTION_TYPE = (0, _keyMirror2.default)({
      ...
      PASS_PURCHASE_SECTION: null
  });

  exports.default = SCROLL_ACTION_TYPE;
  module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _fastclick = __webpack_require__(316);

  var _fastclick2 = _interopRequireDefault(_fastclick);

  var _ComicViewerModal = __webpack_require__(128);

  var _ComicViewerModal2 = _interopRequireDefault(_ComicViewerModal);

  var _ScrollManager = __webpack_require__(130);

  var _ScrollManager2 = _interopRequireDefault(_ScrollManager);

  var _GoogleAnalyticsClient = __webpack_require__(61);

  var _GoogleAnalyticsClient2 = _interopRequireDefault(_GoogleAnalyticsClient);
  ...
  var IndexController = function () {
      function IndexController() {
          ...
          this.gaClient = new _GoogleAnalyticsClient2.default();
      ...
      _createClass(IndexController, [{
          key: 'addHoverEventsToLinks',
          value: function addHoverEventsToLinks() {
              (0, _jquery2.default)('a').on('touchstart mouseenter', function () {
                  (0, _jquery2.default)(this).addClass('hover');
              }).on('touchend mouseleave', function () {
                  (0, _jquery2.default)(this).removeClass('hover');
              });

              (0, _jquery2.default)('.hoverable').on('touchstart mouseenter', function () {
                  (0, _jquery2.default)(this).addClass('hover');
              }).on('touchend mouseleave', function () {
                  (0, _jquery2.default)(this).removeClass('hover');
              });
          ...
          value: function addEventSender() {
              ...
              (0, _jquery2.default)('[href*="webcatalog"]').on('click', function () {
                  return _this.gaClient.goToWebCatalog();
              });
              /* $('[href*="pixiv"]').on('click', (e) => {
                  this.gaClient.goToPixivSample(e.currentTarget.dataset.bookName)
              }); */
              (0, _jquery2.default)('[href^=booth]').on('click', function () {
                  return _this.gaClient.goToBooth();
              });
          }
      }]);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _takeRight = __webpack_require__(333);
  ...
  var ComicViewerModal = function () {
      function ComicViewerModal() {
          _classCallCheck(this, ComicViewerModal);
          ...
          this.$openButton = (0, _jquery2.default)('.js-open-carousel');
      ...
      _createClass(ComicViewerModal, [{
          ...
          value: function addEventToButton() {
          ...
          value: function initHistory() {
              ...
              this.destructHistory = this.history.listen(function (location, action) {
              ...
              var initialState = (0, _takeRight2.default)(location.href.split('/'));
              if (initialState) {
          ...
          value: function scrollLock() {
              this.scrollTop = (0, _jquery2.default)(document).scrollTop();
          ...
          value: function scrollUnlock() {
              ...
              (0, _jquery2.default)(document).scrollTop(this.scrollTop);
          }
      }, {
          key: 'initCarousel',
  ...
  exports.default = ComicViewerModal;
  module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _ScrollPosition = __webpack_require__(90);

  var _ScrollPosition2 = _interopRequireDefault(_ScrollPosition);

  var _ScrollActionType = __webpack_require__(89);

  var _ScrollActionType2 = _interopRequireDefault(_ScrollActionType);
  ...
  var GlobalNavigation = function () {
      function GlobalNavigation() {
          ...
          this.$root = (0, _jquery2.default)('html, body');
          this.$menuContainer = (0, _jquery2.default)('#global-navigation');
          this.$menuItems = (0, _jquery2.default)('#global-navigation').find('.global-navigation__menu-item');
          this.init();
      }
      ...
      _createClass(GlobalNavigation, [{
          ...
          value: function init() {
              ...
              this.$menuContainer.find('.story-section').on('click', function () {
                  var goal = _ScrollPosition2.default.calc();
                  // NOTICE: スクロールアニメーションで向かう位置は、sticky判定のthresholdより僅かに大きくなければならない
                  _this.triggerScroll(goal.storySection__Top + 1);
              ...
              this.$menuContainer.find('.browse-section').on('click', function () {
                  var goal = _ScrollPosition2.default.calc();
                  _this.triggerScroll(goal.browseSection__Top + 1);
              ...
              this.$menuContainer.find('.purchase-section').on('click', function () {
                  var goal = _ScrollPosition2.default.calc();
                  _this.triggerScroll(goal.purchaseSection__Top + 1);
          ...
          key: 'triggerScroll',
          value: function triggerScroll(position) {
          ...
          key: 'emit',
          value: function emit(actionType) {
              switch (actionType) {
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _GlobalNavigation = __webpack_require__(129);
  ...
  var ScrollManager = function () {
      function ScrollManager() {
          ...
          this.globalNavigation = new _GlobalNavigation2.default();
          this.gaClient = new _GoogleAnalyticsClient2.default();
      ...
      _createClass(ScrollManager, [{
          ...
          value: function init() {
              ...
              this.$document.on('scroll', (0, _throttle2.default)(function (e) {
                  if (!isAnimating) {
                      _this.updateByScroll(_this.$document.scrollTop());
                  }
          ...
          value: function updateByScroll(scrollTop) {
              var threshold = _ScrollPosition2.default.calc();
              ...
              switch (true) {
                  ...
                  case scrollTop > threshold.purchaseSection__Top:
                      this.globalNavigation.emit(_ScrollActionType2.default.ENTER_PURCHASE_SECTION);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.id, "@charset 'UTF-8';\n/* Slider */\n.slick-loading .slick-list\n{\n    background: #fff url(" + __webpack_require__(343) + ") center center no-repeat;\n}\n\n/* Icons */\n@font-face\n{\n    font-family: 'slick';\n    font-weight: normal;\n    font-style: normal;\n\n    src: url(" + __webpack_require__(125) + ");\n    src: url(" + __webpack_require__(125) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(346) + ") format('woff'), url(" + __webpack_require__(345) + ") format('truetype'), url(" + __webpack_require__(344) + "#slick) format('svg');\n}\n/* Arrows */\n.slick-prev,\n.slick-next\n{\n    font-size: 0;\n    line-height: 0;\n\n    position: absolute;\n    top: 50%;\n\n    display: block;\n\n    width: 20px;\n    height: 20px;\n    padding: 0;\n    -webkit-transform: translate(0, -50%);\n    -ms-transform: translate(0, -50%);\n    transform: translate(0, -50%);\n\n    cursor: pointer;\n\n    color: transparent;\n    border: none;\n    outline: none;\n    background: transparent;\n}\n.slick-prev:hover,\n.slick-prev:focus,\n.slick-next:hover,\n.slick-next:focus\n{\n    color: transparent;\n    outline: none;\n    background: transparent;\n}\n.slick-prev:hover:before,\n.slick-prev:focus:before,\n.slick-next:hover:before,\n.slick-next:focus:before\n{\n    opacity: 1;\n}\n.slick-prev.slick-disabled:before,\n.slick-next.slick-disabled:before\n{\n    opacity: .25;\n}\n\n.slick-prev:before,\n.slick-next:before\n{\n    font-family: 'slick';\n    font-size: 20px;\n    line-height: 1;\n\n    opacity: .75;\n    color: white;\n\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n}\n\n.slick-prev\n{\n    left: -25px;\n}\n[dir='rtl'] .slick-prev\n{\n    right: -25px;\n    left: auto;\n}\n.slick-prev:before\n{\n    content: '\\2190';\n}\n[dir='rtl'] .slick-prev:before\n{\n    content: '\\2192';\n}\n\n.slick-next\n{\n    right: -25px;\n}\n[dir='rtl'] .slick-next\n{\n    right: auto;\n    left: -25px;\n}\n.slick-next:before\n{\n    content: '\\2192';\n}\n[dir='rtl'] .slick-next:before\n{\n    content: '\\2190';\n}\n\n/* Dots */\n.slick-dotted.slick-slider\n{\n    margin-bottom: 30px;\n}\n\n.slick-dots\n{\n    position: absolute;\n    bottom: -25px;\n\n    display: block;\n\n    width: 100%;\n    padding: 0;\n    margin: 0;\n\n    list-style: none;\n\n    text-align: center;\n}\n.slick-dots li\n{\n    position: relative;\n\n    display: inline-block;\n\n    width: 20px;\n    height: 20px;\n    margin: 0 5px;\n    padding: 0;\n\n    cursor: pointer;\n}\n.slick-dots li button\n{\n    font-size: 0;\n    line-height: 0;\n\n    display: block;\n\n    width: 20px;\n    height: 20px;\n    padding: 5px;\n\n    cursor: pointer;\n\n    color: transparent;\n    border: 0;\n    outline: none;\n    background: transparent;\n}\n.slick-dots li button:hover,\n.slick-dots li button:focus\n{\n    outline: none;\n}\n.slick-dots li button:hover:before,\n.slick-dots li button:focus:before\n{\n    opacity: 1;\n}\n.slick-dots li button:before\n{\n    font-family: 'slick';\n    font-size: 6px;\n    line-height: 20px;\n\n    position: absolute;\n    top: 0;\n    left: 0;\n\n    width: 20px;\n    height: 20px;\n\n    content: '\\2022';\n    text-align: center;\n\n    opacity: .25;\n    color: black;\n\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n}\n.slick-dots li.slick-active button:before\n{\n    opacity: .75;\n    color: black;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _createTransitionManager = __webpack_require__(321);
